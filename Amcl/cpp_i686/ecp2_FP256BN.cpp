...
void FP256BN::ECP2_toOctet(octet *W,ECP2 *Q)
{
    ...
    FP_redc(b,&(qx.b));
    BIG_toBytes(&(W->val[MODBYTES_B256_28]),b);
    FP_redc(b,&(qy.a));
    BIG_toBytes(&(W->val[2*MODBYTES_B256_28]),b);
    FP_redc(b,&(qy.b));
    BIG_toBytes(&(W->val[3*MODBYTES_B256_28]),b);
...
//printf("x\n");
    FP2_conj(&(P->y),&(P->y));
//printf("za = %d zb= %d\n",(P->z).a.g[MPV_B256_28],(P->z).b.g[MPV_B256_28]);
    FP2_conj(&(P->z),&(P->z));
//printf("Into frob  %d\n",(P->z).b.XES);
    FP2_reduce(&(P->z));
    FP2_mul(&(P->x),&X2,&(P->x));
