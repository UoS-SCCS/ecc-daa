...
#define RFS_RSA2048 MODBYTES_B1024_58*FFLEN_RSA2048 /**< RSA Public Key Size in bytes */
...
typedef struct
{
    ...
    B1024_58::BIG n[FFLEN_RSA2048]; /**< An array of BIGs to store public key */
} rsa_public_key;
...
typedef struct
{
    B1024_58::BIG p[FFLEN_RSA2048/2];  /**< secret prime p  */
    B1024_58::BIG q[FFLEN_RSA2048/2];  /**< secret prime q  */
    B1024_58::BIG dp[FFLEN_RSA2048/2]; /**< decrypting exponent mod (p-1)  */
    B1024_58::BIG dq[FFLEN_RSA2048/2]; /**< decrypting exponent mod (q-1)  */
    B1024_58::BIG c[FFLEN_RSA2048/2];  /**< 1/p mod q */
} rsa_private_key;
 ...
 */
extern void RSA_fromOctet(B1024_58::BIG *x,octet *S);
}
