...
#define P_MBITS_RSA2048 (MODBYTES_B1024_58*8)
#define P_TBITS_RSA2048 (P_MBITS_RSA2048%BASEBITS_B1024_58)
#define P_EXCESS_RSA2048(a) (((a[NLEN_B1024_58-1])>>(P_TBITS_RSA2048))+1)
#define P_FEXCESS_RSA2048 ((chunk)1<<(BASEBITS_B1024_58*NLEN_B1024_58-P_MBITS_RSA2048-1))
 ...
 */
extern void FF_copy(B1024_58::BIG *x,B1024_58::BIG *y,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_init(B1024_58::BIG *x,sign32 m,int n);
/**	@brief Set FF element of given size to zero
 *
	@param x FF instance to be set to zero
	@param n size of FF in BIGs
 */
extern void FF_zero(B1024_58::BIG *x,int n);
 ...
 */
extern int FF_iszilch(B1024_58::BIG *x,int n);
/**	@brief  return parity of an FF, that is the least significant bit
 *
	@param x FF number
	@return 0 or 1
 */
extern int FF_parity(B1024_58::BIG *x);
 ...
 */
extern int FF_lastbits(B1024_58::BIG *x,int m);
/**	@brief Set FF element of given size to unity
 *
	@param x FF instance to be set to unity
	@param n size of FF in BIGs
 */
extern void FF_one(B1024_58::BIG *x,int n);
 ...
 */
extern int FF_comp(B1024_58::BIG *x,B1024_58::BIG *y,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_add(B1024_58::BIG *x,B1024_58::BIG *y,B1024_58::BIG *z,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_sub(B1024_58::BIG *x,B1024_58::BIG *y,B1024_58::BIG *z,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_inc(B1024_58::BIG *x,int m,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_toOctet(octet *S,B1024_58::BIG *x,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_fromOctet(B1024_58::BIG *x,octet *S,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_mul(B1024_58::BIG *x,B1024_58::BIG *y,B1024_58::BIG *z,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_mod(B1024_58::BIG *x,B1024_58::BIG *m,int n);
/**	@brief Square an FF
 *
	Uses Karatsuba method internally
	...
	@param n size of FF in BIGs
 */
extern void FF_sqr(B1024_58::BIG *x,B1024_58::BIG *y,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_dmod(B1024_58::BIG *x,B1024_58::BIG *y,B1024_58::BIG *z,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_invmodp(B1024_58::BIG *x,B1024_58::BIG *y,B1024_58::BIG *z,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_random(B1024_58::BIG *x,csprng *R,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_randomnum(B1024_58::BIG *x,B1024_58::BIG *y,csprng *R,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_skpow(B1024_58::BIG *r,B1024_58::BIG *x,B1024_58::BIG * e,B1024_58::BIG *m,int n);
/**	@brief Calculate r=x^e mod m, side channel resistant
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_skspow(B1024_58::BIG *r,B1024_58::BIG *x,B1024_58::BIG e,B1024_58::BIG *m,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_power(B1024_58::BIG *r,B1024_58::BIG *x,int e,B1024_58::BIG *m,int n);
/**	@brief Calculate r=x^e mod m
 *
	@param r FF instance, on exit = x^e mod p
	@param x FF instance
	...
	@param n size of FF in BIGs
 */
extern void FF_pow(B1024_58::BIG *r,B1024_58::BIG *x,B1024_58::BIG *e,B1024_58::BIG *m,int n);
 ...
 */
extern int FF_cfactor(B1024_58::BIG *x,sign32 s,int n);
 ...
 */
extern int FF_prime(B1024_58::BIG *x,csprng *R,int n);
 ...
 *
	...
	@param n size of FF in BIGs
 */
extern void FF_pow2(B1024_58::BIG *r,B1024_58::BIG *x,B1024_58::BIG e,B1024_58::BIG *y,B1024_58::BIG f,B1024_58::BIG *m,int n);
